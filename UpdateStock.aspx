<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateStock.aspx.cs" Inherits="DistPrdMap_UpdStck.UpdateStock" Async="true" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container body-content">
            ...
            <h2 style="text-align: center; margin-top: 20px;">Update Stock</h2>
            <br />

            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-12 col-md-2 mb-2 mb-md-0">
                        <asp:DropDownList ID="DistributorErpId" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="DistributorErpId_SelectedIndexChanged">
                            <asp:ListItem Text="DistributorErpId" Value="DistCode"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-12 col-md-2 mb-2 mb-md-0">
                    ...
                    <div class="col-12 col-md-2 mb-2 mb-md-0">
                        <asp:TextBox ID="Quantity" runat="server" CssClass="form-control" placeholder="Quantity"></asp:TextBox>
                    </div>
                    <div class="col-12 col-md-2 mb-2 mb-md-0">
                        <asp:TextBox ID="Unit" runat="server" CssClass="form-control" placeholder="pcs" ReadOnly="true"></asp:TextBox>
                    </div>
                    <div class="col-12 col-md-2 mb-2 mb-md-0">
                        <asp:Button ID="Submit" runat="server" Text="Submit" CssClass="btn btn-success form-control" OnClick="btnSubmit_Click" />
                    </div>
                    <div class="col-12 col-md-2 mt-2">
                        <asp:Label ID="LabelDetailsError" Text="" runat="server" ForeColor="Red"></asp:Label>
                    </div>
                </div>
            </div>

            <!-- Modal for Product ErpId -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                            ...
                            <div class="form-group">
                                <asp:GridView ID="PrdErpId" runat="server" CssClass="table table-bordered form-group"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PrdNm" HeaderText="Product ErpId" />
                                    </Columns>
